...
SPECS: dict[str, LoadSpec] = {
    "pitcher_games": LoadSpec(
        ...
        numeric_columns=(
            "pitcher_id", "earned_runs", "runs_allowed", "hits", "walks",
    ...
    "pitcher_innings": LoadSpec(
        ...
        allowed_columns=frozenset({
            "pitcher_id", "game_id", "game_date", "inning", "first_inning_runs",
            "first_inning_hits", "first_inning_walks", "first_inning_strikeouts",
            "first_inning_pa",
        }),
        numeric_columns=(
            "pitcher_id", "inning", "first_inning_runs", "first_inning_hits",
            "first_inning_walks", "first_inning_strikeouts", "first_inning_pa",
        ),
    ),
    "statcast_pitcher_daily": LoadSpec(
        ...
        numeric_columns=(
            "pitcher_id", "exit_velocity_sum", "barrels", "hard_hits", "whiffs",
            "swings", "batted_balls",
        ),
    ),
    "team_games": LoadSpec(
    ...
    "team_innings": LoadSpec(
        ...
        required_columns=frozenset({
            "team", "game_id", "game_date", "inning", "first_inning_runs",
        }),
        allowed_columns=frozenset({
            "team", "game_id", "game_date", "inning", "first_inning_runs",
        }),
    ...
    "batter_games": LoadSpec(
        ...
        numeric_columns=(
            "batter_id", "woba_num", "woba_den", "times_on_base",
            "plate_appearances",
        ),
    ),
...
def load_dataset(dataset: str, path: str | Path, source: str,
                 loader: SnowflakeLoader | None = None) -> int:
